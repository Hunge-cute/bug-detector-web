          ...
          <div className="flex flex-col justify-center space-y-4">
            <div className="space-y-2">
              <h1 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl lg:text-6xl/none">
                Find and Fix Bugs with LLMs, Confidently
              </h1>
              <p className="max-w-[600px] text-muted-foreground md:text-xl">
                BugCatch uses large language models combined with data-flow
                sanitization to detect real bugs and suppress false positives —
                then generates patched code in one click.
              </p>
            </div>
            ...
            <div className="flex items-center space-x-4 text-sm">
              ...
              <div className="flex items-center space-x-1">
                <CheckCircle className="h-4 w-4 text-primary" />
                <span className="text-muted-foreground">LLM Powered</span>
              </div>
            </div>
          </div>
  ...
  System.out.println("Result: " + result);
                ...
                <div className="absolute inset-0 bg-background/85 flex flex-col items-center justify-center p-4 opacity-0 transition-opacity duration-300 group-hover:opacity-100">
                  <div className="text-center space-y-4">
                    <p className="font-semibold text-xl">BugCatch Detected:</p>
